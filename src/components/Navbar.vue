<template>
  ...
  >
    ...
    >
      <li class="lg:hidden">
        <button
          class="flex lg:hidden absolute right-3 top-3 z-10 text-white hover:bg-white hover:text-blue-700 rounded"
          ref="closeMenu"
        >
    ...
    <div class="flex lg:mr-3">
      ...
      <button class="flex lg:hidden text-white hover:bg-white hover:text-blue-700 rounded" ref="openMenu">
